...
`;
    ...
    return (
      ...
      <div className={headerStyles.headerContainer}>
       ...
       <a href="https://www.github.com/ron-hughes"><img src={GitHubImage} alt="Github Icon"/></a>
      <a href="https://www.linkedin.com/in/ron-hughes/"><img src={LinkedInImage} alt="LinkedIn Icon" /></a>
      <a href="https://twitter.com/eyecodethings"><img src={TwitterImage} alt="Twitter Icon"/></a>
      <img src={EmailImage} />
         </div> 
